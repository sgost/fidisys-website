...
export const COCONUT_WHITE = '#FDFDFD';
...
// text colors
export const HEADING_COLOR = '#29B6F6';
export const PRIMARY_TXT_COLOR = '#EEEEEE';
export const SECONDARY_TXT_COLOR = '#DDDDDD';

// button colors
export const BUTTON_PRIMARY = '#0199FF';
